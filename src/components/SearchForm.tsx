...
import { Search, Sparkles, SlidersHorizontal, Loader2, HelpCircle, Layers, Split } from 'lucide-react';
...
export const SearchForm: React.FC<SearchFormProps> = ({
  ...
  return (
    <div className="w-full bg-white rounded-2xl shadow-xl shadow-slate-200/50 border border-slate-100 p-4 md:p-6 transition-all">
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          <label htmlFor="seed-keyword-input" className="block text-xs font-semibold uppercase tracking-wider text-slate-500 mb-1.5 flex items-center justify-between">
            <span>Enter Seed Keyword or Wildcard Query</span>
