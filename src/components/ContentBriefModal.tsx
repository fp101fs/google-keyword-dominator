...
import { X, Copy, Check, FileText, Sparkles, HelpCircle, Layers, Gauge, Loader2 } from 'lucide-react';
...
---
*Generated by Google Keyword Dominator (GKD) with Google Gemini AI Intelligence*
`;
          ...
          <div className="p-4 sm:p-6 overflow-y-auto space-y-6 flex-1 text-sm bg-slate-50/50">
            {isLoadingLlm ? (
              <div className="p-10 text-center space-y-3 bg-white rounded-2xl border border-slate-200">
                ...
                <p className="text-xs font-bold text-slate-700">Synthesizing SEO Content Architecture via LLM...</p>
              </div>
            ) : (
              <>
                {/* Suggested Title */}
